...
TOKEN = '7225492054:AAFG62fBwViAwaFks8sBUw5UIvPGZzXU70Y'
MONGO_URI = os.getenv('MONGO_URI', 'mongodb+srv://piroop:piroop@piro.hexrg9w.mongodb.net/?retryWrites=true&w=majority&appName=piro&tlsAllowInvalidCertificates=true')

# Define the URL of your Codespace environment
CODESPACE_URL = os.getenv('CODESPACE_URL', 'https://zany-guide-4j97wpx9q7g27g46.github.dev/')#codespacelink
...
FORWARD_CHANNEL_ID = -1002211986811
CHANNEL_ID = -1002211986811
error_channel_id = -1002211986811
            ...
            if user_data['plan'] == 499 or (user_data['plan'] == 99 and user_data['access_count'] < 10):
                ...
                try:
                 ...
                 #   proxy_command = f"export http_proxy={PROXY_URL} && export https_proxy={PROXY_URL} && "
                    ...
                    bot.reply_to(message, f" Attack Unsuccessfull ❄️\n\nError: {e}")
    except Exception as e:
        print(e)
...
def send_credits(message):
    chat_id = message.chat.id
    bot.send_message(chat_id, "This bot was created by SOULCRACKS. All rights reserved.")
